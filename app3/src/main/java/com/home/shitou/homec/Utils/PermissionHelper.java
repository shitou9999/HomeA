...
public class PermissionHelper {
     ...
     */
    public void requestPermissions(@NonNull CharSequence hintMessage,@Nullable PermissionListener listener,
...
/*
    ...
    mHelper.requestPermissions("请授予xx[相机]，[读写]权限！",new PermissionHelper.PermissionListener() {
        @Override
